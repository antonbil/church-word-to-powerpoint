...
class InputDialog:
    ...
    def get_keyboard_keys(self, sg, gui):
        ...
        return [sg.pin(sg.Column(col, visible=self.keyboard_visible_at_start, expand_x=True, key='Column', metadata=False), expand_x=True)]

    def get_keyboard_button(self, sg, gui):
        self.keyboard_visible = self.keyboard_visible_at_start
